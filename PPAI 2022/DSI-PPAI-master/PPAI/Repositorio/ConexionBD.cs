...
namespace PPAI.Repositorio
{
    public class ConexionBD
    {
        ...
        private ConexionBD()
        {
            string_conexion = "Data Source=200.69.137.167,11333;Initial Catalog=DSI_3K2_grupo5;User ID=DSI_3K2_grupo5;Password=-.DSI_3K2_grupo5"; ;
        }
        ...
        public int EjecutarTransaccionSQL(string strSql)
        {
            ...
            if (_cmd.ExecuteNonQuery() > 0)
            {
                ...
                //id = int.Parse(null);
                if (idDevuelto != null)
                    id = Convert.ToInt16(idDevuelto.ToString());
